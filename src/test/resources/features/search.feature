...
Funcionalidade: Pesquisa de artigos do Blog do Agi
  ...
  @smoke
  Cenário: Busca por termo inexistente exibe mensagem de sem resultados
    # Valida o comportamento do sistema quando nenhum artigo corresponde ao termo.
    # Um bom sistema deve informar o usuário de forma clara que nada foi encontrado.
    Quando clico no ícone de busca
    Então o overlay de busca deve ser exibido
    Quando digito o termo de busca "xyzqwerty123456789"
    E submeto a busca
    Então devo ser redirecionado para a página de resultados
    E uma mensagem de nenhum resultado deve ser exibida
